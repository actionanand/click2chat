...
```bash
git clone https://github.com/actionanand/click2chat.git --branch 1-skeleton new-proj-name
```

```bash
npx degit github:actionanand/click2chat#1-skeleton new-proj-name
```

```bash
npx gitpick https://github.com/actionanand/click2chat -b 1-skeleton
```
